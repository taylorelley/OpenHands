...
export enum I18nKey {
  ...
  SETTINGS$NAV_APPEARANCE = "SETTINGS$NAV_APPEARANCE",
  SETTINGS$APPEARANCE_DESCRIPTION = "SETTINGS$APPEARANCE_DESCRIPTION",
  SETTINGS$AVAILABLE_THEMES = "SETTINGS$AVAILABLE_THEMES",
  SETTINGS$ADD_THEME = "SETTINGS$ADD_THEME",
  SETTINGS$THEMES_EMPTY = "SETTINGS$THEMES_EMPTY",
  SETTINGS$THEMES_LOAD_ERROR = "SETTINGS$THEMES_LOAD_ERROR",
  SETTINGS$THEME_ACTIVE_BADGE = "SETTINGS$THEME_ACTIVE_BADGE",
  SETTINGS$THEME_MENU = "SETTINGS$THEME_MENU",
  SETTINGS$THEME_EDIT = "SETTINGS$THEME_EDIT",
  SETTINGS$THEME_SET_ACTIVE = "SETTINGS$THEME_SET_ACTIVE",
  SETTINGS$THEME_ACTIVATED = "SETTINGS$THEME_ACTIVATED",
  SETTINGS$THEME_RENAME_TITLE = "SETTINGS$THEME_RENAME_TITLE",
  SETTINGS$THEME_RENAMED = "SETTINGS$THEME_RENAMED",
  SETTINGS$THEME_DELETE_TITLE = "SETTINGS$THEME_DELETE_TITLE",
  SETTINGS$THEME_DELETE_CONFIRMATION = "SETTINGS$THEME_DELETE_CONFIRMATION",
  SETTINGS$THEME_DELETED = "SETTINGS$THEME_DELETED",
  SETTINGS$THEME_CREATE_TITLE = "SETTINGS$THEME_CREATE_TITLE",
  SETTINGS$THEME_EDIT_TITLE = "SETTINGS$THEME_EDIT_TITLE",
  SETTINGS$THEME_CREATED = "SETTINGS$THEME_CREATED",
  SETTINGS$THEME_UPDATED = "SETTINGS$THEME_UPDATED",
  SETTINGS$THEME_PRIMARY_COLOR = "SETTINGS$THEME_PRIMARY_COLOR",
  SETTINGS$THEME_BASE_COLOR = "SETTINGS$THEME_BASE_COLOR",
  SETTINGS$THEME_BASE_SECONDARY_COLOR = "SETTINGS$THEME_BASE_SECONDARY_COLOR",
  SETTINGS$THEME_CONTENT_COLOR = "SETTINGS$THEME_CONTENT_COLOR",
  SETTINGS$THEME_APP_NAME = "SETTINGS$THEME_APP_NAME",
  SETTINGS$THEME_LOGO_URL = "SETTINGS$THEME_LOGO_URL",
